...
$sql = "SELECT * FROM users WHERE role = 'CR' AND department = ?";
              ...
              <?php if ($result->num_rows > 0) : ?>
                <?php while($row = $result->fetch_assoc()) : ?>
                  <tr>
                    ...
                    <td>
                      <a href="edit_cr.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary btn-sm"><i class="bi bi-pencil-square"></i> </a>
                    </td>
                    <td>
