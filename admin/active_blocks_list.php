...
$sql = "SELECT id, block_name, description, status FROM blocks $search_query where status ='active'";
                ...
                <?php
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <a href='view_block.php?id=" . $row['block_name'] . "' class='btn btn-success btn-sm'><i class='bi bi-eye-fill'></i> </a>
                                </td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='5'>No blocks registered</td></tr>";
                    }
                    $conn->close();
                ?>
